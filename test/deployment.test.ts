...
describe('deployment', () => {
    ...
    it('default values', () => {
        ...
        const deployment = byKind.Deployment(readAndClean('test/default.snapshot.yaml'))[0];
    ...
    it('variant-1', () => {
        ...
        const deployment = byKind.Deployment(readAndClean('test/variant-1.snapshot.yaml'))[0];
        let actual = Testing.synth(chart);
        const actualDeployment = byKind.Deployment(actual)[0];
        expect(actualDeployment).toEqual(deployment);
    });
    ...
    it('variant-2', () => {
        ...
        const deployment = byKind.Deployment(readAndClean('test/variant-2.snapshot.yaml'))[0];
        let actual = Testing.synth(chart);
        const actualDeployment = byKind.Deployment(actual)[0];
        expect(actualDeployment).toEqual(deployment);
    ...
    it('variant-3', () => {
        ...
        const deployment = byKind.Deployment(readAndClean('test/variant-3.snapshot.yaml'))[0];
        let actual = Testing.synth(chart);
        const actualDeployment = byKind.Deployment(actual)[0];
        expect(actualDeployment).toEqual(deployment);
